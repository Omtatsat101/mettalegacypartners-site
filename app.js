  ...
  if (form) {
    form.addEventListener("submit", async function (e) {
      ...
      var lead = {
        ...
        source: "contact_legacy",
        domain: "mettalegacypartners.com",
      ...
      var results = await Promise.allSettled([
        ...
        (function(){
          var w = new FormData();
          w.append("access_key", cfg.WEB3FORMS_KEY || "REPLACE_WITH_WEB3FORMS_KEY_LEGACY");
          w.append("subject", "mettalegacypartners.com — new inquiry from " + lead.name);
          w.append("from_name", "mettalegacypartners.com");
      ...
      if (anyOk) {
        ...
        form.reset();
        if (window.gtag) gtag("event", "contact_submit", { domain: "mettalegacypartners.com" });
      } else {
        if (status) { status.textContent = "Something broke. Email hey@mettalegacypartners.com directly."; status.className = "cm-status is-error"; }
      }
    });
  }
})();
